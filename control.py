...
def unpack_from_bytes(file_bytes: bytes):
        ...
        try:
            ...
            pic_to_pic = thermogram.picture_in_picture_pil(mask=mask, 
                                                           mask_mode='classical', 
                                                           render_opacity=0.8,
                                                           edge_emphasis=0.2)
            ...
            img1 = cv2.cvtColor(np.array(grayscale), cv2.COLOR_RGB2GRAY)
            img2 = cv2.cvtColor(optical, cv2.COLOR_RGB2GRAY)
